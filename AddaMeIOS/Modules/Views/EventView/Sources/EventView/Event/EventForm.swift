...
//  @EnvironmentObject var appState: AppState
  ...
  @State private var selectedPlace = EventResponse.Item.draff
  var currentPlace = EventResponse.Item.draff

  var searchTextBinding: Binding<String> {
    Binding<String>(
      get: {
        return eventViewModel.currentEventPlace.addressName
      },
      set: { newString in
...
//                  self.selectedPlace = locationManager.currentEventPlace
  ...
  func send() {
    ...
    guard let currenUser: User = KeychainService.loadCodable(for: .user) else {
