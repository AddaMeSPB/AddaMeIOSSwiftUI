...
public struct HTTPError: Error {
  ...
  public static var nonHTTPResponse: Self {
    .init(description: "Non-HTTP response received")
  }
  
  public static var missingTokenFromIOS: Self {
    .init(description: "JWT token are missing on ios app")
  }
  
  public static func requestFailed(_ statusCode: Int) -> Self {
    return .init(description: "Request Failed HTTP with error - \(statusCode)")
  }
  
  public static func serverError(_ statusCode: Int) -> Self {
    return .init(description: "Server Error - \(statusCode)")
  }
  
  public static func networkError(_ error: Error) -> Self {
    return .init(description: "Failed to load the request: \(error)")
  }
  
  
  public static func authError(_ statusCode: Int) -> Self {
    return .init(description: "Authentication Token is expired: \(statusCode)")
  }
  
  public static func decodingError(_ decError: DecodingError) -> Self {
    return .init(description: "Failed to process response: \(decError)")
  }
  
  public static func unhandledResponse(_ statusCode: Int) -> Self {
    return .init(description: "Unhandled HTTP Response Status code: \(statusCode)")
  }
