  ...
  targets: [
    .target(
      ...
      dependencies: [
        ...
        "AuthClient", "ChatClient", "ConversationClient", "ContactClient", "CoreDataClient",
        "CoreDataStore", "EventClient", "LocationClient", "PathMonitorClient",
        "UserClient", "WebsocketClient", "EventView", "UserView", "ContactsView",
        "ChatView", "CombineContacts",
